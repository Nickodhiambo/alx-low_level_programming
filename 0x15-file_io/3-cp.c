...
/**
 * create_buffer - Allocates 1024 bytes in memory for a buffer.
 * @file: Name of file that stores chars
 *
 ...
 * Return: 0 on success.
 *
 * Description: If the argument count is incorrect, exit code is 97.
